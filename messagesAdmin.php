...
<body>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js">
   ...
   <?php include 'php/navBarAdmin.php'; ?> <!-- Start of email section -->
   <!-- Messages -->
   <?php 
  ...
  if (isset($_GET['delete'])) {
      ...
      if ($delete) {
          header("location:messagesAdmin.php"); //Redirects to the inbox page
      }else {
  ...
  <div class="container-fluid regContainer col-md-10">
    <div class="row justify-content-center">
      <div class="col-md-12">
        ...
        <!-- Compose Button -->
        <div class="text-center">
          <a class="btn btn-primary btn" href="sendMessageAdmin.php" id="composeMessageAdmin" name="composeMessageAdmin" role="button">Compose New Message</a>
        </div><br>
