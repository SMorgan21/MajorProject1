...
if ($_POST['editMatchReport']) {
     ...
     //Reports Table
  $league = mysqli_real_escape_string($dbcon, $_POST['changeLeague']);
  $homeTeam = mysqli_real_escape_string($dbcon, $_POST['changeHomeTeam']);
  $awayTeam = mysqli_real_escape_string($dbcon, $_POST['changeAwayTeam']);
  $datePlayed = mysqli_real_escape_string($dbcon, $_POST['changeDatePlayed']);
  $location = mysqli_real_escape_string($dbcon, $_POST['changeLocation']);
  $surname1 = mysqli_real_escape_string($dbcon,$_POST['changeSurname1']);
  $surname1Clean = filter_var($surname1, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
  $firstName1 = mysqli_real_escape_string($dbcon,$_POST['changeFirstName1']);
  $firstName1Clean = filter_var($firstName1, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
  $caution1 = mysqli_real_escape_string($dbcon,$_POST['changeCaution1']);
  $team1 = mysqli_real_escape_string($dbcon,$_POST['changeTeam1']);
  $sendOff1 = mysqli_real_escape_string($dbcon,$_POST['changeSendOff1']);
  $surname2 = mysqli_real_escape_string($dbcon,$_POST['changeSurname2']);
  $surname2Clean = filter_var($surname2, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
  $firstName2 = mysqli_real_escape_string($dbcon,$_POST['changeFirstName2']);
  $firstName2Clean = filter_var($firstName2, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
  $caution2 = mysqli_real_escape_string($dbcon,$_POST['changeCaution2']);
  $team2 = mysqli_real_escape_string($dbcon,$_POST['changeTeam2']);
  $surname3 = mysqli_real_escape_string($dbcon,$_POST['changeSurname3']);
  $surname3Clean = filter_var($surname3, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
  $firstName3 = mysqli_real_escape_string($dbcon,$_POST['changeFirstName3']);
  $firstName3Clean = filter_var($firstName3, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
  $caution3 = mysqli_real_escape_string($dbcon,$_POST['changeCaution3']);
  $team3 = mysqli_real_escape_string($dbcon,$_POST['changeTeam3']);
  $surname4 = mysqli_real_escape_string($dbcon,$_POST['changeSurname4']);
  $surname4Clean = filter_var($surname4, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
  $firstName4 = mysqli_real_escape_string($dbcon,$_POST['changeFirstName4']);
  $firstName4Clean = filter_var($firstName4, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
  $caution4 = mysqli_real_escape_string($dbcon,$_POST['changeCaution4']);
  $team4 = mysqli_real_escape_string($dbcon,$_POST['changeTeam4']);
  $surname5 = mysqli_real_escape_string($dbcon,$_POST['changeSurname5']);
  $surname5Clean = filter_var($surname5, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
  $firstName5 = mysqli_real_escape_string($dbcon,$_POST['changeFirstName5']);
  $firstName5Clean = filter_var($firstName5, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
  $caution5 = mysqli_real_escape_string($dbcon,$_POST['changeCaution5']);
  $team5 = mysqli_real_escape_string($dbcon,$_POST['changeTeam5']);
  $surname6 = mysqli_real_escape_string($dbcon,$_POST['changeSurname6']);
  $surname6Clean = filter_var($surname6, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
  $firstName6 = mysqli_real_escape_string($dbcon,$_POST['changeFirstName6']);
  $firstName6Clean = filter_var($firstName6, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
  $caution6 = mysqli_real_escape_string($dbcon,$_POST['changeCaution6']);
  $team6 = mysqli_real_escape_string($dbcon,$_POST['changeTeam6']);
  $surname7 = mysqli_real_escape_string($dbcon,$_POST['changeSurname7']);
  $surname7Clean = filter_var($surname7, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
  $firstName7 = mysqli_real_escape_string($dbcon,$_POST['changeFirstName7']);
  $firstName7Clean = filter_var($firstName7, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
  $caution7 = mysqli_real_escape_string($dbcon,$_POST['changeCaution7']);
  $team7 = mysqli_real_escape_string($dbcon,$_POST['changeTeam7']);
