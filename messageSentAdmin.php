...
<body>
  ...
  <div class="text-center">
    <p>Message Sent Succesfully</p>
      <a href="profileAdmin.php" class="btn btn-primary" title="Click here to return to your hompage">Return to homepage</a>
     <a href="messagesAdmin.php" class="btn btn-primary" title="Click here to return to your inbox">Return to inbox</a>
  </div>
  </div>
  </div>
  </div>
