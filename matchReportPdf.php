...
if (!empty($_POST['submitMatchReport'])) {
  ...
  $reportData = $dbcon->query("INSERT INTO reports1 (reffFK, reffUserName, league, homeTeam, awayTeam, location, datePlayed, surname1, firstName1, caution1, team1, sendOff1, surname2, firstName2, caution2, team2, surname3, firstName3, caution3, team3,  surname4, firstName4, caution4, team4, surname5, firstName5, caution5, team5, surname6, firstName6, caution6, team6, surname7, firstName7, caution7, team7) Values ('$reffId', '$reffUserName', '$league', '$homeTeam', '$awayTeam', '$location', '$datePlayed', '$surname1Clean', '$firstName1Clean', '$caution1', '$team1', '$sendOff1', '$surname2Clean', '$firstName2Clean', '$caution2', '$team2', '$surname3Clean', '$firstName3Clean', '$caution3', '$team3', '$surname4Clean', '$firstName4Clean', '$caution4', '$team4', '$surname5Clean', '$firstName5Clean', '$caution5', '$team5', '$surname6Clean', '$firstName6Clean', '$caution6', '$team6', '$surname7Clean', '$firstName7Clean', '$caution7', '$team7')");
