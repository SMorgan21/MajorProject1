...
if (isset($_POST['login'])) {//listening for the login button
  ...
  $data = $dbcon->query("SELECT id, password FROM refDetails WHERE email='$email'");//executes a query to the database which selects an id and password that matches the email entered
      ...
      <div class="col-md-6 col-md-offset-3">
        ...
        <div class="container-fluid" id="regContainer">
          <form name="regForm" method="post" action="loginTest.php">
            ...
            <a href="registration.php" class="btn btn-primary btn-block" role="button"  name="register">Click here to get an account</a>
            <a href="forgotPassword.php" class="btn btn-primary btn-block" role="button"  name="forgotPassword">Cant remember your password? Click here</a>
