...
<body>
	...
	<a href="changePasswordAdmin.php" class="btn btn-primary">Click here to try again</a>
	</div>
	</div>
	</div>
	</div>';
	...
	<?php echo $message; ?>
	<form>
		<input class='btn btn-primary btn-block' id='changePasswordAdmin' name='changePasswordDetails' type='submit' value='Change Password'>
	</form>"; } 
	?>
</body>
</html>